...
```{r}
longtext %>% ggplot(aes(x = Group_factor, y = Count))+geom_bar() +
  labs(title="Total Number of Text Messages: Baseline vs.6 Months By Group ",
       x=" Text Messages", y = "Frequency") + facet_grid(Group~.) 
```


```{r facet bar plot, echo = FALSE, include=F, message=FALSE, warning=FALSE, fig.width=8, fig.height=6, fig.align='center'}
